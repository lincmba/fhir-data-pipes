...
public class OpenmrsUtil {
  ...
  OpenmrsUtil(String sourceFhirUrl, String sourceUser, String sourcePw, String oidConnectUrl, String clientId,
    String clientSecret, String oAuthUsername, String oAuthPassword, FhirContext fhirContext)
